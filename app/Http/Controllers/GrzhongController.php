...
class GrzhongController extends Controller
{
    ...
    {   
        ...
        return view('home.grzx.index',compact('shangpin','shang','pin','women','tags','gw','youlians','huobans','peizhi'));
    }
    ...
    {   
        ...
        $shang = Sp::where('orlogin','0')->where('user_id',session('id'))->count();
        $pin = Sp::where('orlogin','1')->where('user_id',session('id'))->count();
        return view('home.grzx.gerendd',compact('shangpin','shang','pin','di','tags','women','gw','youlians','huobans','peizhi'));
    }
    ...
    {   
        ...
        $shang = Sp::where('orlogin','0')->where('user_id',session('id'))->count();
        $pin = Sp::where('orlogin','1')->where('user_id',session('id'))->count();
       return view('home.grzx.shouhuodizhi',compact('shangpin','shang','pin','di','tags','women','huo','gw','youlians','huobans','peizhi'));
    }
    ...
    {   
        ...
        $shang = Sp::where('orlogin','0')->where('user_id',session('id'))->count();
        $pin = Sp::where('orlogin','1')->where('user_id',session('id'))->count();
       return view('wel',compact('shangpin','shang','pin','di','tags','women','huo','peizhi'));
    }
    ...
    {   
        ...
        $gw = Car::all();
        $youlians = Youlian::all();
        return view('home.wod.yonh',compact('pin','gw','shang','women','tags','user','youlians','huobans','peizhi'));
    }
