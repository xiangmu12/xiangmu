	...
	<div id="NavDrawer" class="drawer drawer--left">
		...
		<ul class="mobile-nav">
			...
			<ul class="mobile-nav__sublist megamenu__dropdown mobile_megamenu_1">
				...
				<a href="#"><img src="/assets/assets/images/logo-b.png" alt=""></a>
				<p>
		...
		<div id="adv-banner">
			<div id="ads-banner" class="grid--full grid--table">
				<div class="ads-banner-slider owl-carousel">
					<div class="ads-item">
						<img src="/assets/assets/images/ads1.png" alt="ads banner 1">
					</div>						
					<div class="ads-item">
						<img src="/assets/assets/images/ads2.png" alt="ads banner 2">
					</div>
					<div class="ads-item">
						<img src="/assets/assets/images/ads3.png" alt="ads banner 3">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="wrapper">
								...
								<ul class="sdcollections-list">
											...
											<li class="grid__item large--one-half">
												<ul>
													...
													<div class="list-product-image">
														<a href="product.html"><img src="/assets/assets/images/demo1_210x210.png" alt="Example Book"></a>
													</div>
									...
									<li class="sdc-element vetical-menu2 site-nav--has-dropdown" aria-haspopup="true">
										<a href="collection.html" class="site-nav__link">
											<div class="element-main">
												<div class="collection-icon">
													<img src="/assets/assets/images/beauty-health.png" alt="collection icon">
												</div>
												<div class="collection-area have-icons">
													<div class="collection-name">
														 Beauty &amp; Health (36)
										...
										<ul class="site-nav__dropdown vetical__dropdown vetical__dropdown1">
											...
											<li class="grid__item large--one-half">
												<ul>
													...
													<li class="list-product">
													<div class="list-product-image">
														<a href="product.html"><img src="/assets/assets/images/demo2_210x210.jpg" alt="Demo Product Sample"></a>
													</div>
													<div class="list-product-name">
														Demo Product Sample
													</div>
									...
									<li class="sdc-element">
										<a href="collection.html">
											<div class="element-main">
												<div class="collection-icon">
													<img src="/assets/assets/images/homelife.png" alt="collection icon">
												</div>
												<div class="collection-area have-icons">
													<div class="collection-name">
														 Homelife (8)
									...
									<li class="sdc-element">
										<a href="collection.html">
											<div class="element-main">
												<div class="collection-icon">
													<img src="/assets/assets/images/appliances.png" alt="collection icon">
												</div>
												<div class="collection-area have-icons">
													<div class="collection-name">
														 Home Appliances (8)
									...
									<li class="sdc-element vetical-menu3 site-nav--has-dropdown" aria-haspopup="true">
										<a href="collection.html" class="site-nav__link">
											<div class="element-main">
												<div class="collection-icon">
													<img src="/assets/assets/images/smartphones.png" alt="collection icon">
												</div>
												<div class="collection-area have-icons">
													<div class="collection-name">
										...
										<ul class="site-nav__dropdown vetical__dropdown vetical__dropdown1">
											...
											<li class="grid__item large--one-half">
												<ul>
													...
													<li class="list-product">
													<div class="list-product-image">
														<a href="product.html"><img src="/assets/assets/images/demo3_210x210.jpg" alt="Etiam dan lorem quis"></a>
													</div>
													<div class="list-product-name">
									...
									<li class="sdc-element">
										<a href="collection.html">
											<div class="element-main">
												<div class="collection-icon">
													<img src="/assets/assets/images/camera.png" alt="collection icon">
												</div>
												<div class="collection-area have-icons">
													<div class="collection-name">
														 Camera - Camcorder (37)
									...
									<li class="sdc-element">
										<a href="collection.html">
											<div class="element-main">
												<div class="collection-icon">
													<img src="/assets/assets/images/clothing.png" alt="collection icon">
												</div>
												<div class="collection-area have-icons">
													<div class="collection-name">
														 Clothing (6)
									...
									<li class="sdc-element">
										<a href="collection.html">
											<div class="element-main">
												<div class="collection-icon">
													<img src="/assets/assets/images/kids-baby.png" alt="collection icon">
												</div>
												<div class="collection-area have-icons">
													<div class="collection-name">
														 Kids &amp; Baby (6)
									...
									<li class="sdc-element">
										<a href="collection.html">
											<div class="element-main">
												<div class="collection-icon">
													<img src="/assets/assets/images/sport.png" alt="collection icon">
												</div>
												<div class="collection-area have-icons">
													<div class="collection-name">
														 Sport &amp; Outdoor (6)
									...
									<li class="sdc-element">
										<a href="collection.html">
											<div class="element-main">
												<div class="collection-icon">
													<img src="/assets/assets/images/stationery.png" alt="collection icon">
												</div>
												<div class="collection-area have-icons">
													<div class="collection-name">
														 Stationery (15)
				...
				<div id="beauty-health-blocks" class="beauty-health-wrapper grid--full grid--table grid-block-full">
					<div class="beauty-health-inner">
						<div class="bh-top home-block-title">
							<div class="collection-name">
								<img class="collection-icon" src="/assets/assets/images/beauty-health.png" alt=""><a href="collection.html">Beauty &amp; Health</a>
							</div>
							...
							<div class="grid__item three-quarters bh-left small--one-whole medium--one-whole">
								<div class="home-slideshow-block bh-slideshow">
									<div class="home-gallery-slider">
										<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide1_880x285.jpg" alt=""></a></div>
										<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide2_880x285.jpg" alt=""></a></div>
										<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide3_880x285.jpg" alt=""></a></div>    
									</div>
								</div>
										...
										<div class="home-products-slider">
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product1_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product2_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product3_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product4_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product5_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
				...
				<div id="smartphones-blocks" class="smartphones-wrapper grid--full grid--table grid-block-full">
					<div class="smartphones-inner">
						<div class="bh-top home-block-title">
							<div class="collection-name">
								<img class="collection-icon" src="/assets/assets/images/smartphones.png" alt="">
								<a href="collection.html">Smartphones &amp; Cell Phones</a>
							</div>
							<div class="collection-tags">
								<ul class="bh-tags">          
						...
						<div class="bh-btm">
							<div class="grid__item three-quarters bh-left small--one-whole medium--one-whole">
								<div class="home-slideshow-block bh-slideshow">
									<div class="home-gallery-slider">
										<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide4_880x285.jpg" alt=""></a></div>
										<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide5_880x285.jpg" alt=""></a></div>
										<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide6_880x285.jpg" alt=""></a></div>    
									</div>
								</div>
								<div class="home-products-block bh-products">
									<div class="home-products-block-title">
										...
										<div class="home-products-slider">
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product6_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product7_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product8_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product9_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product10_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
							...
							<div class="grid__item one-quarter bh-right small--one-whole medium--one-whole">
								...
								<div class="banner-area">
									<a href="collection.html"><img src="/assets/assets/images/demo1_banner2_185x345.png" alt=""></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div id="kids-blocks" class="kids-wrapper grid--full grid--table grid-block-full">
					<div class="kids-inner">
						<div class="bh-top home-block-title">
						    <div class="collection-name">
								<img class="collection-icon" src="/assets/assets/images/clothing.png" alt="">
						...
						<div class="bh-btm">
							...
							<div class="grid__item three-quarters bh-left small--one-whole medium--one-whole">
								<div class="home-slideshow-block bh-slideshow">
									<div class="home-gallery-slider">
										<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide7_880x285.jpg" alt=""></a></div>
										<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide8_880x285.jpg" alt=""></a></div>
										<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide9_880x285.jpg" alt=""></a></div>    
									</div>
								</div>
								<div class="home-products-block bh-products">
									<div class="home-products-block-title">
										...
										<div class="home-products-slider">
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product11_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product12_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product13_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product14_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="product.html">
															<img src="/assets/assets/images/demo1_product15_208x208.jpg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
							...
							<div class="grid__item one-quarter bh-right small--one-whole medium--one-whole">
								...
								<div class="banner-area">
									<a href="collection.html"><img src="/assets/assets/images/demo1_banner3_185x345.png" alt=""></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div id="accessories-blocks" class="accessories-wrapper grid--full grid--table grid-block-full">
					<div class="accessories-inner">
						<div class="bh-top home-block-title">
							<div class="collection-name">
								<img class="collection-icon" src="/assets/assets/images/sport.png" alt=""><a href="collection.html">Sport &amp; Outdoor</a>
							</div>
							<div class="collection-tags">
								<ul class="bh-tags">          
						...
						<div class="bh-btm">
							<div class="bh-btm">
								...
								<div class="grid__item three-quarters bh-left small--one-whole medium--one-whole">
									<div class="home-slideshow-block bh-slideshow">
										<div class="home-gallery-slider">
											<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide10_880x285.jpg" alt=""></a></div>
											<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide11_880x285.jpg" alt=""></a></div>
											<div><a href="collection.html"><img src="/assets/assets/images/demo1_slide12_880x285.jpg" alt=""></a></div>    
										</div>
									</div>
									<div class="home-products-block bh-products">
										<div class="home-products-block-title">
											...
											<div class="home-products-slider">
												<div class="grid__item">
													<div class="grid__item_wrapper">
														<div class="grid__image product-image">
															<a href="product.html">
																<img src="/assets/assets/images/demo1_product16_208x208.jpg" alt="Demo Product Sample">
															</a>
															<div class="quickview">
																<div class="product-ajax-cart hidden-xs hidden-sm">
																	<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
												...
												<div class="grid__item">
													<div class="grid__item_wrapper">
														<div class="grid__image product-image">
															<a href="product.html">
																<img src="/assets/assets/images/demo1_product17_208x208.jpg" alt="Demo Product Sample">
															</a>
															<div class="quickview">
																<div class="product-ajax-cart hidden-xs hidden-sm">
																	<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
												...
												<div class="grid__item">
													<div class="grid__item_wrapper">
														<div class="grid__image product-image">
															<a href="product.html">
																<img src="/assets/assets/images/demo1_product18_208x208.jpg" alt="Demo Product Sample">
															</a>
															<div class="quickview">
																<div class="product-ajax-cart hidden-xs hidden-sm">
																	<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
												...
												<div class="grid__item">
													<div class="grid__item_wrapper">
														<div class="grid__image product-image">
															<a href="product.html">
																<img src="/assets/assets/images/demo1_product19_208x208.jpg" alt="Demo Product Sample">
															</a>
															<div class="quickview">
																<div class="product-ajax-cart hidden-xs hidden-sm">
																	<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
												...
												<div class="grid__item">
													<div class="grid__item_wrapper">
														<div class="grid__image product-image">
															<a href="product.html">
																<img src="/assets/assets/images/demo1_product20_208x208.jpg" alt="Demo Product Sample">
															</a>
															<div class="quickview">
																<div class="product-ajax-cart hidden-xs hidden-sm">
																	<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
								...
								<div class="grid__item one-quarter bh-right small--one-whole medium--one-whole">
									...
									<div class="banner-area">
										<a href="collection.html"><img src="/assets/assets/images/demo1_banner4_185x345.png" alt=""></a>
									</div>
								</div>
							</div>
						</div>
