合作@extends('layouts.admin') @section('title') 合作添加 @endsection @section('title','合作添加') @section('content')
<hr>
...
<div class="tpl-portlet-components">
    <div class="portlet-title">
        <div class="caption font-green bold">
            <span class="am-icon-code"></span> 合作添加
        </div>
    </div>
    <div class="tpl-block">
        <div class="am-g">
            <div class="tpl-form-body tpl-form-line">
                <form class="am-form tpl-form-line-form" method="post" action="/huoban" enctype="multipart/form-data">
