    ...
    <div class="tpl-block">
        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="/dcate/{{$v['id']}}/edit" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                        <form style="float:left" action="/dcate/{{$v['id']}}" method="post">
                                            {{method_field('DELETE')}}
                                            {{csrf_field()}}
                ...
                <div class="am-cf">
                    <div class="am-fr">
                        {{ $dcates->appends(request()->all())->links() }}
                    </div>
                </div>
                <hr>
            </div>
