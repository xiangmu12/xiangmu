@extends('layouts.admin') @section('title','logo列表') @section('content')
<div class="tpl-portlet-components">
    <div class="portlet-title">
        <div class="caption font-green bold">
            <span class="am-icon-code"></span> logo列表
        </div>
     ...
     <div class="am-g">
        <div class="am-u-sm-12">
            <form class="am-form">
                <table class="am-table am-table-striped am-table-hover table-main">
                    <thead>
                        <tr>
                            ...
                            <th class="table-title">logo名</th>
                            <th class="table-title">logo图片</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="am-hide-sm-only">{{$v->dcate['name']}}</td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <form action="" method="get">

                                            <a style="float:left" href="/logo/{{$v['id']}}/edit" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                        </form>
             ...
             <div class="am-cf">
                <div class="am-fr">
                    {{ $logos->appends(request()->all())->links() }}
                </div>
            </div>
            <hr>
        </form>
